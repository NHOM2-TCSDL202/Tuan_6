...
ALTER TABLE DONDATHANG
    ADD CONSTRAINT fk_DONDATHANG_NHANVIEN FOREIGN KEY (MANHANVIEN) REFERENCES NHANVIEN(MANHANVIEN) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE CHITIETDATHANG
    ADD CONSTRAINT fk_CHITIETDATHANG_MATHANG FOREIGN KEY (MAHANG) REFERENCES MATHANG(MAHANG) ON UPDATE CASCADE ON DELETE CASCADE;
